...
To get this:  
[![Grafana dashboard showing Docker CPU, memory, and network metrics](https://media.vpetkov.net/wp-content/uploads/2016/08/docker_metrics01.webp)][1]

[![Grafana Docker metrics dashboard thumbnail](https://media.vpetkov.net/wp-content/uploads/2016/08/docker_metrics02.webp)][2]  
...
[![Grafana data source configuration screen for InfluxDB](https://media.vpetkov.net/wp-content/uploads/2016/08/grafana_data_source.webp)][3]
...
[![Grafana panel menu showing the Add Graph option](https://media.vpetkov.net/wp-content/uploads/2016/08/add_graph.webp)][4]

And here's an example of how you would modify the "search" by point and click:  
[![Grafana graph configuration with the metrics query builder](https://media.vpetkov.net/wp-content/uploads/2016/08/grafana_configure.webp)][5]
...
And the tutorials on docker and metrics were basically non existent. Rancher's guide is the most "current and complete" doc on this as of today, in terms of what's available, and you can find it [HERE](http://rancher.com/comparing-monitoring-options-for-docker-deployments/).
 ...
 [1]: https://media.vpetkov.net/wp-content/uploads/2016/08/docker_metrics01.webp
 [2]: https://media.vpetkov.net/wp-content/uploads/2016/08/docker_metrics02.webp
 [3]: https://media.vpetkov.net/wp-content/uploads/2016/08/grafana_data_source.webp
 [4]: https://media.vpetkov.net/wp-content/uploads/2016/08/add_graph.webp
 [5]: https://media.vpetkov.net/wp-content/uploads/2016/08/grafana_configure.webp